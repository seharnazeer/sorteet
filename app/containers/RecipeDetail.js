...
import { getCartList, saveCartData, clearCartData, saveCurrency_Symbol } from "../utils/AsyncStorageHelper";
...
class RecipeDetail extends React.PureComponent {
    ...
    componentDidMount = () => {
        ...
        if (this.restaurantDetails !== undefined && this.restaurantDetails !== null && this.restaurantDetails.restaurant_timings !== undefined &&
            this.restaurantDetails.restaurant_timings !== null
        ) {
            this.restaurantDetails.timings = this.restaurantDetails.restaurant_timings
        }
    }
   ...
   */
                            ...
                            : (this.cartDataDict.items !== undefined && this.cartDataDict.items.some(item => item.menu_id === this.item.menu_id && item.quantity >= 1) ?
                                ...
                                <View>
                                    <EDRTLView style={style.qtyContainer}>
                                        <Icon name="remove-circle" size={getProportionalFontSize(22)} color={EDColors.primary} onPress={this.onMinusClick}
                                        />
                                        ...
                                        <Icon name="add-circle" size={getProportionalFontSize(22)} color={EDColors.primary} onPress={this.onPlusClick} />
                ...
                if (success != undefined) {
                    ...
                    if (cartArray.length > 0) {
                        if (success.resId == this.resId) {
                            ...
                            this.tempQty = qty
                            this.setState({ visible: false, isCartModalVisible: true, isCustomItem: false, recipeVisible: false, isLoading: false })
                        }
    ...
    saveData(data) {
        ...
        this.props.saveCurrencySymbol(this.currency_symbol)
        saveCurrency_Symbol(this.currency_symbol, () => { }, () => { })
