...
class RecipeContainer extends React.Component {
            ...
            <>
                ...
                >
                    <EDImage
                        ...
                        style={[style.imgStyle, { height: 160, marginBottom: 10 }]}
                        resizeMode={'cover'}
    ...
    onRecipeEventhandler = (item) => {
        this.props.navigation.navigate("RecipeDetail", {
            ...
            restaurantDetails: item.is_recipes_menu !== undefined && item.is_recipes_menu !== null && item.is_recipes_menu == 1 ? item.restaurant : {},
