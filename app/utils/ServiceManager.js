...
import { ADD_ADDRESS, ADD_NEW_CARD, ADD_ORDER, ADD_ORDER_REVIEW, ADD_REVIEW, ADD_TO_CART, APPLY_COUPON, APP_VERSION, BOOKING_EVENT, BOOKING_HISTORY, BOOKING_TABLE, CANCEL_ORDER, CHANGE_TOKEN, CHECK_BOOKING_AVAIL, CHECK_CARD_PAYMENT, CHECK_ORDER_URL, CHECK_TABLE_AVAIL, CMS_PAGE, CONTACT_US, COUNTRY_CODE_LIST, COUNTRY_CODE_URL, CREATE_PAYMENT_METHOD, CREATE_PAYMENT_ONLINE, debugLog, DELETE_ACCOUNT, DELETE_ADDRESS, DELETE_CARD, DELETE_EVENT, DRIVER_TRACKING, FAQ_URL, FORGOT_PASSWORD, GET_ADDRESS, GET_CANCEL_REASON_LIST, GET_FOOD_TYPE, GET_NOTIFICATION, GET_QR_POINTS, GET_RECIPE_LIST, GET_RESTAURANT_DETAIL, GET_RESTAURANT_MENU, GET_REVIEW, GET_SAVED_CARDS, GET_USER_LANGUAGE, LANGUAGE_LIST, LOGIN_URL, LOGOUT_URL, ORDER_LISTING, PAYMENT_LIST, PROMO_CODE_LIST, QR_SCAN, REGISTRATION_HOME, REGISTRATION_URL, REPORT_ERROR, RequestKeys, RESET_PASSWORD_REQ_URL, SEND_OTP_API, SOCIAL_URL, TIP_DRIVER, UPDATE_CARD, UPDATE_PROFILE, VALIDATE_SCHEDULING, VERIFY_OTP_API, WALLET_HISTORY, WALLET_TOPUP, WALLET_CASH_TRF } from "../utils/EDConstants";
...
export function rechargeWalletCashTrfAPI(transactionParam, onSuccess, onFailure, propsFromContainer, isStringify) {
    callAPI(WALLET_CASH_TRF, transactionParam, onSuccess, onFailure, RequestType.post, getRequestHeader(propsFromContainer), propsFromContainer, isStringify);
}
