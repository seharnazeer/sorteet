...
import { debugLog, funGetTomorrowDate, getProportionalFontSize } from "../utils/EDConstants";
...
export default class EDDatePicker extends Component {
    ...
    constructor(props) {
        super(props)
        this.maxDate = this.props.maxDate || new Date(moment(new Date()).add(30, 'day'))
        this.minDate = this.props.minDate || funGetTomorrowDate()
    }
    ...
    componentWillReceiveProps = newProps => {
        this.setState({ markedDates: newProps.markedDates, key: this.state.key + 1 })
    }
    render() {
        return (
            <View style={styles.calenderView} >
                ...
                <View style={styles.calenderSubView}>
                    <Calendar
                        ...
                        disabledByDefault={this.props.disabledByDefault || false}
                        markingType={'simple'}
                        theme={{
