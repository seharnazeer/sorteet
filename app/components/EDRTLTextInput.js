...
export default class EDRTLTextInput extends Component {
    ...
    onCountrySelect = country => {
        this.setState({
            code: country.cca2, dialCode:
                country.callingCode.length !== 0 ?
                    country.callingCode[0] : "N/A"
        })
                        ...
                        <View style={{
                                ...
                                <CountryPicker
                                    ...
                                    renderFlagButton={() => {
                                        return <TouchableOpacity
                                            style={{ flexDirection: 'row', marginRight: 5.5, alignItems: "center" }}
                                            ...
                                            {this.props.editableBox !== undefined &&
                                                ...
                                                <Icon name="caret-down" type="font-awesome" size={getProportionalFontSize(16)}
                            ...
                            {this.props.isForTemperature
                                ...
                                : <TextInput
                                    ...
                                    onSubmitEditing={this.props.onSubmitEditingHandler || undefined}
                                    onChangeText={
