...
export default class FoodOverview extends React.PureComponent {
    ...
    animateImage = () => {
        this.setState({ isAnimating: true })
        Animated.timing(this.imageHeight, {
            toValue: this.state.animated ? getProportionalFontSize(85) : getProportionalFontSize(125),
            duration: 200,
            easing: Easing.ease,
            useNativeDriver: false
        }).start();
        Animated.timing(this.animatedRadius, {
            toValue: this.state.animated ? getProportionalFontSize(8) : getProportionalFontSize(16),
            duration: 200,
            easing: Easing.ease,
            useNativeDriver: false
        }).start();
        ...
        Animated.timing(this.imageWidth, {
            toValue: this.state.animated ? getProportionalFontSize(85) : this.actualWidth - getProportionalFontSize(32),
            duration: 200,
            easing: Easing.ease,
            useNativeDriver: false
        }).start(() => {
        ...
        return (
            <TouchableOpacity
                ...
                <EDRTLView style={style.container}>
                    ...
                    <Animated.View style={[style.sideImage, { width: this.imageWidth, height: this.imageHeight, backgroundColor: '#f1eff0', borderRadius: this.animatedRadius ,overflow :"hidden",marginVertical : 5}]}>
                    <TouchableOpacity
                        activeOpacity={1}
