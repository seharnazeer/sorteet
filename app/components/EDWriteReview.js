...
export default class EDWriteReview extends Component {
    ...
    buttonSubmitReviewPressed = () => {
        ...
        if (this.orderData.delivery_flag != 'pickup' && this.orderData.driver !== undefined && this.orderData.driver !== null && this.validationsHelper.checkForEmpty(this.state.objReviewDetails.driverRemarks.trim(), strings('requiredField')).length > 0 ||
