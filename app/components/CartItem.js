    ...
    render() {
        return (
            ...
            <View style={style.container}>
                <EDRTLView style={style.imageContainer}>
                    ...
                    : null} */}
                        ...
                        <EDRTLView style={style.qunContainer}>
                            ...
                            <Text style={{ margin: 5, fontFamily: EDFonts.regular, fontSize: getProportionalFontSize(13) }}>{(this.props.forRemoval == true ? (strings("quantity") + " - ") : "") + this.state.quantity}</Text>
                            {this.props.forRemoval !== true ?
                                <TouchableOpacity
                                    onPress={() => {
                                                ...
                                                <EDRTLView style={style.addOnSubView}>
                                                    {this.quantity !== 1 ?
                                                        <EDRTLView style={{ flex: 1 }}>
                                                            <Text style={style.addOnText}>{items.add_ons_name.trim()}</Text>
                ...
                <EDRTLView style={{ flex: 1, paddingTop: 7.5, borderTopColor: EDColors.separatorColorNew, borderTopWidth: 1, alignItems: "center", marginBottom: 10, marginHorizontal: 10, justifyContent: "space-between" }}>
                    <EDRTLView style={{ flex: .875, alignItems: "center", }}>
                    ...
                    {this.props.items.comment !== undefined &&
                        ...
                        this.props.items.comment !== "" ?
                        <EDRTLText title={
                            strings("remove")} style={[style.removeBtn, { textAlign:"right"}]}
...
export const style = StyleSheet.create({
    ...
    addOnTitleText: { marginBottom: 4, fontSize: getProportionalFontSize(13), fontFamily: EDFonts.regular, color: EDColors.black, textDecorationLine: 'underline' },
    comboText: { fontSize: getProportionalFontSize(13), fontFamily: EDFonts.medium, margin: 5, marginVertical: 2.5 },
    ...
    addOnText: { flex: 1, fontSize: getProportionalFontSize(13), fontFamily: EDFonts.medium, color: "#999999" },
    addOnPriceText: { flex: 1, marginRight: 10, textAlign: 'right', fontSize: getProportionalFontSize(13), fontFamily: EDFonts.medium, color: "#999999" },
    addOnPrice: { flex: 1, color: "#999999", marginHorizontal: 10, fontSize: getProportionalFontSize(13), fontFamily: EDFonts.medium },
    totalPrice: { fontSize: getProportionalFontSize(13), marginTop: 5, fontFamily: EDFonts.medium, color: EDColors.black, marginHorizontal: 5 }
});
